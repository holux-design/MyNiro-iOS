    ...
    var body: some View {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            if let location = store.parkedLocation {
                                ParkedLocationMap(location: location, vehicleName: store.displayName)
                            }
        ...
        .sheet(isPresented: $showChargeLimit) {
            ChargeLimitSheet(store: store)
                .presentationDetents([.height(108)])
...
private struct ParkedLocationMap: View {
    ...
    init(location: VehicleStatus.Location, vehicleName: String) {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            HStack {
                Text(String(localized: "Last location"))
                ...
                Button {
                    ...
                    .padding(.vertical, 6)
                    .background(MyNiroTheme.green.opacity(0.18), in: Capsule())
                }
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "Directions to parked car"))
            }

            Map(position: $cameraPosition, interactionModes: [.pan, .zoom]) {
                Annotation(vehicleName, coordinate: coordinate) {
                    ZStack {
                        Circle()
                            .fill(MyNiroTheme.green.opacity(0.28))
                        ...
                        Image(systemName: "car.fill")
                            ...
                            .overlay(Circle().strokeBorder(MyNiroTheme.green.opacity(0.7), lineWidth: 1))
                    }
                }
            }
        ...
        .accessibilityLabel(String(localized: "Parked location map"))
    }
...
struct BatteryCard: View {
    ...
    var body: some View {
        BatteryStatusCard(
            ...
            rangeKm: store.rangeKm,
            targetSocAC: store.targetSocAC,
            isCharging: store.displayAsCharging,
            chargeSpeedKW: store.chargeSpeedKW,
            chargeTimeText: store.chargeTimeText,
            onTapLimit: onTapLimit
        ) {
